...
const RESUME_PATH = "/Anant_Gabhane_Resume.pdf";
        ...
        <div className="mb-4 w-full flex justify-start py-6">
            {!isOpen ? (
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <a
                        href={RESUME_PATH}
                        download="Anant_Gabhane_Resume.pdf"
                        className="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white/70 px-3 py-1.5 text-[10px] font-bold uppercase tracking-[0.18em] text-gray-500 transition-all duration-300 hover:border-blue-500/40 hover:bg-blue-500/5 hover:text-blue-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-gray-400 dark:hover:border-blue-500/40 dark:hover:bg-blue-500/10 dark:hover:text-blue-400"
                    >
                        <Download size={12} />
                        Download MY CV
                    </a>
                ...
                <div className="w-full max-w-5xl">
                    <a
                        href={RESUME_PATH}
                        download="Anant_Gabhane_Resume.pdf"
                        className="mb-3 inline-flex w-full items-center justify-center gap-2 rounded-2xl border border-blue-200/70 bg-blue-500/8 px-4 py-3 text-[11px] font-bold uppercase tracking-[0.2em] text-blue-600 transition-all duration-300 hover:border-blue-500/50 hover:bg-blue-500/12 hover:text-blue-700 dark:border-blue-500/20 dark:bg-blue-500/10 dark:text-blue-400 dark:hover:border-blue-500/40 dark:hover:bg-blue-500/15 dark:hover:text-blue-300"
                    >
                        <Download size={14} />
                        Download My CV
                    </a>
                    ...
                    <motion.div
                        ...
                        className="w-full overflow-hidden rounded-2xl border border-gray-100 bg-white/40 p-6 backdrop-blur-md dark:border-zinc-800/50 dark:bg-black/40"
                    >
                        ...
                        <div className="mt-8 grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
                            <div className="relative flex aspect-[4/3] w-full items-center justify-center rounded-xl border border-gray-100/50 bg-gray-50/30 p-4 dark:border-zinc-800/30 dark:bg-zinc-900/20">
