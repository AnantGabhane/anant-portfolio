export const getMarkdownContent = (time: string) => `# Anant Gabhane
/əˈnʌnt ɡəˈbʱaːne/ • noun • ${time || "00:00:00"} IST

## About

A Gen AI full-stack developer and [product builder](https://en.wikipedia.org/wiki/Product_design) with deep experience across engineering, product strategy, and user-centric design.
...
Created a user-friendly Next.js frontend enabling secure login, backend communication, and scheduling of permission requests, illustrating Gen AI full-stack development capabilities and focus on intuitive user experiences.
...
Authors: Anant Gabhane; T. S. Sreeram
