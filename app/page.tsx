              ...
              <div className="space-y-12">
                ...
                >
                  <div className="space-y-2">
                    ...
                    <p>Created a user-friendly Next.js frontend enabling secure login, backend communication, and scheduling of permission requests, illustrating Gen AI full-stack development capabilities and focus on intuitive user experiences.</p>
                  </div>
                </ExperienceItem>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-1">
                      ...
                      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-4">
                        <p className="text-gray-600 dark:text-gray-400">Authors: Anant Gabhane; T. S. Sreeram</p>
                        <a
